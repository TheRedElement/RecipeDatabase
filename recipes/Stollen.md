...
4. add $\pu{2tbsp}$ of **milk** to **yeast (dry)**
...
4. optionally you can add **marzipan** into your **Stollen**
	1. when [Stollen Shaping](#Stollen%20Shaping) divide into two loafs
	2. flatten both loafs
	3. flatten **marzipan**
	4. sandwich **marzipan** between flattened loafs
	5. continue as per usual 
		1. flatten half of the sandwich to about $\pu{2.5cm}$ thickness
