...
acknowledgements:
  - Oma Sylvia
links:
  - https://www.oetker.de/rezepte/r/wespennester
theme: tre_light
marp: false
paginate: false
---
...
- based on [Windbaeckerei](Windbaeckerei.md)
...
1. extract **egg white**
2. grate zest of **oranges**
3. beat until stiff ([EggwhiteStiffness](../resources/EggwhiteStiffness.md))
4. add **sugar**
	1. keep beating until creamy
5. add **orange zests**, **cinnamon**
	1. carefully  work them into the base
...
3. bake on central rack for $30\,\mathrm{min}$
	1. it's actually more drying than baking
4. take out of the oven and let dry for $\approx 1\,\mathrm{h}$
...
4. carefully mix in **sugar**, **cinnamon**
5. fold in **chocolate**
